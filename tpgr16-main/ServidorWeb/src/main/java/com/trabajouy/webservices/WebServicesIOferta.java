...
public interface WebServicesIOferta {
    ...
    @Action(input = "http://webservices/WebServicesIOferta/obtenerDtOfertaRequest", output = "http://webservices/WebServicesIOferta/obtenerDtOfertaResponse", fault = {
        ...
        @FaultAction(className = OfertaNoExisteException_Exception.class, value = "http://webservices/WebServicesIOferta/obtenerDtOferta/Fault/OfertaNoExisteException")
    })
    public DtOferta obtenerDtOferta(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0)
        throws OfertaNoExisteException_Exception, TipoPubNoExisteException_Exception
    ;
    ...
    @WebMethod
    @WebResult(partName = "return")
    @Action(input = "http://webservices/WebServicesIOferta/obtenerPostulantesFavoritosRequest", output = "http://webservices/WebServicesIOferta/obtenerPostulantesFavoritosResponse")
    public DtPostulanteArray obtenerPostulantesFavoritos(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0);
     ...
     */
    @WebMethod
    @Action(input = "http://webservices/WebServicesIOferta/cargarVisitasRequest", output = "http://webservices/WebServicesIOferta/cargarVisitasResponse")
     ...
     */
    @WebMethod
    @Action(input = "http://webservices/WebServicesIOferta/visitarRequest", output = "http://webservices/WebServicesIOferta/visitarResponse")
    public void visitar(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0);
